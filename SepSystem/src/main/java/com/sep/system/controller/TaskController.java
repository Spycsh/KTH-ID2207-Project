...
public class TaskController {
    ...
    public String editTaskRequest(HttpServletRequest request, Map<String, Object> map,
     ...
     public String insertTestTask(){
         ...
         taskList.add(new Task(0, 7, "flower photo", "take a picture of flower", 6,1000, "production", "high", "Draft","tobias"));
         taskList.add(new Task(0, 9, "cook dinner", "cook beef with wine", 9,2000, "service", "medium", "Draft","helene"));
         for(Task t : taskList){
